/* eslint-disable @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any, @typescript-eslint/method-signature-style, @typescript-eslint/no-unnecessary-qualifier, @typescript-eslint/array-type, @typescript-eslint/consistent-type-definitions, @typescript-eslint/unified-signatures */
