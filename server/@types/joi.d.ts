/* eslint-disable @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any, @typescript-eslint/method-signature-style, @typescript-eslint/no-unnecessary-qualifier, @typescript-eslint/unified-signatures */

/**
 * Joi 17 shim for `joi-extract-type`
 *
 * @author panzelva
...
declare module "joi" {
	interface Root {
		...
		alternatives<T extends Array<mappedSchema>>(
			...alts: T
		...
		alt<T extends Array<mappedSchema>>(
			...alts: T
		): BoxAlternativesSchema<Box<extractType<typeof alts[number]>, false>>;
	...
	interface BoxArraySchema<N extends BoxSchema> extends joi.ArraySchema {
		...
		items(...types: Array<joi.SchemaLike>): this;
		items(types: Array<joi.SchemaLike>): this;
	...
	interface BoxAlternativesSchema<N extends BoxSchema> extends joi.AlternativesSchema {
		...
		try<T extends Array<mappedSchema>>(
			...values: T
		...
		try(...types: Array<joi.SchemaLike>): this;
		try(types: Array<joi.SchemaLike>): this;
